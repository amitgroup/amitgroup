...
wavedec2 = ag.util.wavelet.wavedec2d_factory({0}, levels={1})
waverec2 = ag.util.wavelet.waverec2d_factory({0}, levels={1})
...
if __name__ == '__main__':
    ...
    plt.legend(('pywt (wavedec2d)', 'amitgroup (wavedec2d)', 'pywt (waverec2d)', 'amitgroup (waverec2d)'), loc=0)
