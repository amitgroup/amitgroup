...
def extract_parts(edges, unspread_edges, log_parts, log_invparts, int threshold, outer_frame=0, spread_radii=(4, 4), subsample_size=(4, 4), int collapse=1, accept_threshold=0.0):
    cdef:
